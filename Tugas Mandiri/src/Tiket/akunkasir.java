...
public class akunkasir extends JFrame {
	...
	public akunkasir() {
		...
		btnDAFTAR.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				daftar ();
				clear ();
				javax.swing.JOptionPane.showMessageDialog(null, "Selamat pembuatan akun kasir SUKSES:)");
			}
		});
		...
		JLabel lblNewLabel = new JLabel("DAFTAR AKUN KASIR");
	...
	public void daftar (){
		...
		try{
			...
			String query = "INSERT INTO kasir(userid, password) values (?,?)"; 
